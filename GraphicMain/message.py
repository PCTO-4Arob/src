...
def final_animation( screen, surf_title, spr_red, spr_blue, winRed, all_sprites):
    ...
    spr_redReverse.image = pygame.image.load(os.path.join(pathname, "Sprites/redCowBoy.png")).convert_alpha()
